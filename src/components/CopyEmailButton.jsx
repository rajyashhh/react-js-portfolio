...
const CopyEmailButton = () => {
    ...
    const email = "workmail.yrs@gmail.com";
  ...
  return (<motion.button
            ...
            whileHover={{y:-5}}
            whileTap={{scale: 1.05}} className='relative px-1 py-4 text-sm text-center rounded-full font-extralight bg-primary w-[15rem] cursor-pointer overflow-hidden'>
